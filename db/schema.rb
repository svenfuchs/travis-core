...
ActiveRecord::Schema.define(:version => 20131108145708) do
  ...
  add_foreign_key "log_parts", "logs", name: "log_parts_log_id_fk"

  add_foreign_key "permissions", "repositories", name: "permissions_repository_id_fk", dependent: :delete
  add_foreign_key "permissions", "users", name: "permissions_user_id_fk", dependent: :delete
